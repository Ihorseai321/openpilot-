...
public:
    ...
    bool update(long_log_t mpc_solution, float cur_time, bool active, float v_ego, float a_ego, float x_lead, float v_lead, float a_lead, float y_lead, float vlat_lead, bool fcw_lead, bool blinkers);
