...
float PIController::update(float *kpBP, float *kpV, int size_p, float *kiBP, float *kiV, int size_i, 
                           float setpoint, float measurement, float speed, float deadzone, float feedforward, 
                           bool freeze_integrator, bool check_saturation, bool override)
{
    this->speed = speed;
