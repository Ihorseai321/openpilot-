...
def main(argv):
  ...
  # del address_mapping['pathPlan']
  # del address_mapping['plan']
  address_mapping = {'frame': 'frame', 'sensorEvents': 'sensorEvents', 'gpsNMEA': 'gpsNMEA', 'thermal': 'thermal', 'can': 'can', 'controlsState': 'controlsState', 'features': 'features', 'health': 'health', 'radarState': 'radarState', 'encodeIdx': 'encodeIdx', 'liveTracks': 'liveTracks', 'sendcan': 'sendcan', 'logMessage': 'logMessage', 'liveCalibration': 'liveCalibration', 'androidLog': 'androidLog', 'carState': 'carState', 'carControl': 'carControl', 'liveLocation': 'liveLocation', 'gpsLocation': 'gpsLocation', 'ethernetData': 'ethernetData', 'navUpdate': 'navUpdate', 'qcomGnss': 'qcomGnss', 'lidarPts': 'lidarPts', 'procLog': 'procLog', 'gpsLocationExternal': 'gpsLocationExternal', 'ubloxGnss': 'ubloxGnss', 'clocks': 'clocks', 'liveMpc': 'liveMpc', 'liveLongitudinalMpc': 'liveLongitudinalMpc', 'navStatus': 'navStatus', 'gpsLocationTrimble': 'gpsLocationTrimble', 'trimbleGnss': 'trimbleGnss', 'ubloxRaw': 'ubloxRaw', 'gpsPlannerPoints': 'gpsPlannerPoints', 'gpsPlannerPlan': 'gpsPlannerPlan', 'applanixRaw': 'applanixRaw', 'orbLocation': 'orbLocation', 'trafficEvents': 'trafficEvents', 'liveLocationTiming': 'liveLocationTiming', 'orbslamCorrection': 'orbslamCorrection', 'liveLocationCorrected': 'liveLocationCorrected', 'orbObservation': 'orbObservation', 'applanixLocation': 'applanixLocation', 'liveLocationKalman': 'liveLocationKalman', 'uiNavigationEvent': 'uiNavigationEvent', 'orbOdometry': 'orbOdometry', 'orbFeatures': 'orbFeatures', 'orbKeyFrame': 'orbKeyFrame', 'uiLayoutState': 'uiLayoutState', 'frontEncodeIdx': 'frontEncodeIdx', 'orbFeaturesSummary': 'orbFeaturesSummary', 'driverMonitoring': 'driverMonitoring', 'liveParameters': 'liveParameters', 'liveMapData': 'liveMapData', 'cameraOdometry': 'cameraOdometry', 'kalmanOdometry': 'kalmanOdometry', 'thumbnail': 'thumbnail', 'carEvents': 'carEvents', 'carParams': 'carParams', 'frontFrame': 'frontFrame'}
  
  # address_mapping = {'gpsNMEA': 'gpsNMEA', 'gpsLocation': 'gpsLocation', 'gpsLocationExternal': 'gpsLocationExternal', 'gpsLocationTrimble': 'gpsLocationTrimble', 'gpsPlannerPoints': 'gpsPlannerPoints', 'gpsPlannerPlan': 'gpsPlannerPlan', 'androidLog': 'androidLog', 'frame': 'frame', 'sensorEvents': 'sensorEvents', 'gpsNMEA': 'gpsNMEA', 'thermal': 'thermal', 'can': 'can', 'health': 'health', 'radarState': 'radarState', 'gpsLocation': 'gpsLocation', 'ubloxRaw': 'ubloxRaw', 'liveParameters': 'liveParameters', 'driverMonitoring': 'driverMonitoring', 'thumbnail': 'thumbnail', 'frontFrame': 'frontFrame'} # {'model': 'model','radarState': 'radarState','liveParameters': 'liveParameters'}
